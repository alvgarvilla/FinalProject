...
% ------------------------------------------------------------------
\newcommand{\TITLE}{Distributed Denial of Service Attack and OpenFlow:}
\newcommand{\SUBTITLE}{Improving defense mechanism of DDoS with OpenFlow}
...
% Example of one supervisor:
 \newcommand{\SUPERVISOR}{Aapo Kalliola M.Sc. (Tech.)}
% Example of twosupervisors:
%\newcommand{\SUPERVISOR}{Professor Keijo Heljanko}


% If you have only one instructor, just write one name here
\newcommand{\INSTRUCTOR}{Aapo Kalliola M.Sc. (Tech.)}
...
% The contentthesis are separated to their own files.
